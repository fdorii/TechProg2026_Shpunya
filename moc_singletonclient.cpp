...
void SingletonClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SingletonClient::*)(QString )>(_a, &SingletonClient::msg_from_server, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SingletonClient::*)()>(_a, &SingletonClient::connected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SingletonClient::*)()>(_a, &SingletonClient::disconnected, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SingletonClient::*)(QString )>(_a, &SingletonClient::errorOccurred, 3))
            return;
    }
}
...
// SIGNAL 0
void SingletonClient::msg_from_server(QString _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void SingletonClient::connected()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SingletonClient::disconnected()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void SingletonClient::errorOccurred(QString _t1)
{
